 ...
 */
@Entity
@Table(name="information_weight_filtrate")
public class InformationWeightFiltrate implements Serializable {
	@Id
	@GeneratedValue(generator="uuid")
	@GenericGenerator(name="uuid",strategy="uuid")
	@Column(name="weight_filtrate_id",length=40, nullable=false)
	private String weightFiltrateId;
	...
	public InformationWeightFiltrate() {
		super();
		// TODO Auto-generated constructor stub
	}

	public InformationWeightFiltrate(String weightFiltrateId, CrawlerSource crawlerSource,
			CrawlerManagement crawlerManagement, double crawlerScore, String informationId, String title,
			String readWeight, double readWeightFactor, int readCount, double readScore, String commentWeight,
			double commentWeightFactor, int commentCount, double commentScore, String likeWeight,
			double likeWeightFactor, int likeCount, double likeScore, String wordWeight, double wordWeightFactor,
			int wordCount, double wordScore, String url, Date createdTime, double informationScore,
			CrawlerCategory crawlerCategory, Date lastUpdate) {
		super();
		this.weightFiltrateId = weightFiltrateId;
		this.crawlerSource = crawlerSource;
		this.crawlerManagement = crawlerManagement;
	...
	public String toString() {
		return "InformationWeightFiltrate [weightFiltrateId=" + weightFiltrateId + ", crawlerSource=" + crawlerSource
