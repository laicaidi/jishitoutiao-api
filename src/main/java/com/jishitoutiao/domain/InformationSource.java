...
public class InformationSource implements Serializable {
	...
	@Column(name="information_id",length=40)
	...
	public InformationSource(CrawlerSource crawlerSource, CrawlerManagement crawlerManagement, String informationId,
			String title, int readCount, int commentCount, int likeCount, int wordCount, String url, Date createdTime,
	...
	public String toString() {
		return "InformationSource [crawlerSource=" + crawlerSource + ", crawlerManagement=" + crawlerManagement
