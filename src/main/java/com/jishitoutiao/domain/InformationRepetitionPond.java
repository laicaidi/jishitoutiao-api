 ...
 */
@Entity
@Table(name="information_repetition_pond")
public class InformationRepetitionPond implements Serializable {
	@Id
	@GeneratedValue(generator="uuid")
	@GenericGenerator(name="uuid",strategy="uuid")
	@Column(name="repetition_pond_id",length=40, nullable=false)
	private String repetitionPondId;
	
	@Column(name="repetition_num",length=40, nullable=false)
	...
	public void setRepetitionNum(String repetitonNum) {
		this.repetitionNum = repetitonNum;
	}
	...
	public InformationRepetitionPond() {
		super();
		// TODO Auto-generated constructor stub
	}
	public InformationRepetitionPond(String repetitionPondId, String repetitonNum, CrawlerSource crawlerSource,
	...
	public String toString() {
		return "InformationRepetitionPond [repetitionPondId=" + repetitionPondId + ", repetitionNum=" + repetitionNum
