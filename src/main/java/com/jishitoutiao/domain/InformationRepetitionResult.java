 ...
 */
@Entity
@Table(name="information_repetition_result")
public class InformationRepetitionResult implements Serializable {
	@Id
	@GeneratedValue(generator="uuid")
	@GenericGenerator(name="uuid",strategy="uuid")
	@Column(name="repetition_result_id",length=40, nullable=false)
	private String repetitionResultId;
	...
	public InformationRepetitionResult() {
		super();
		// TODO Auto-generated constructor stub
	}
	public InformationRepetitionResult(String repetitionResultId, String repetitionNum, CrawlerSource crawlerSource,
	...
	public String toString() {
		return "InformationRepetitionResult [repetitionResultId=" + repetitionResultId + ", repetitionNum="
