 ...
 */
@Entity
@Table(name="information_weight_sort")
public class InformationWeightSort implements Serializable {
	@Id
	@GeneratedValue(generator="uuid")
	@GenericGenerator(name="uuid",strategy="uuid")
	@Column(name="weight_sort_id",length=40, nullable=false)
	private String weightSortId;
	...
	public InformationWeightSort() {
		super();
		// TODO Auto-generated constructor stub
	}

	public InformationWeightSort(String weightSortId, CrawlerSource crawlerSource, CrawlerManagement crawlerManagement,
	...
	public String toString() {
		return "InformationWeightSort [weightSortId=" + weightSortId + ", crawlerSource=" + crawlerSource
